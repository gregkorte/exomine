...
export const editGovernor = async (id, obj) => {
  ...
  const response = await fetch(
    `http://localhost:8088/governors/${id}`,
    patchOptions
  );
  return response.json();
};
...
export const editColony = async (id, obj) => {
  ...
  const response = await fetch(
    `http://localhost:8088/colonies/${id}`,
    patchOptions
  );
  return response.json();
};
...
export const getFacilityInventory = async () => {
  const response = await fetch(
    "http://localhost:8088/facilityInventory?_expand=mineral&_expand=facility"
  );
  return await response.json();
};

export const editFacility = async (id, obj) => {
  // console.log(`EditFacility fired id-${id}:, `, obj);
  delete obj.id;
  const patchOptions = {
    method: "PATCH",
    headers: {
  ...
  const response = await fetch(
    `http://localhost:8088/facilities/${id}`,
    patchOptions
  );
  return response.json();
};
...
export const editFacilityInventory = async (id, obj) => {
  ...
  const response = await fetch(
    `http://localhost:8088/facilityInventory/${id}`,
    patchOptions
  );
  return response.json();
};
...
export const getColonyInventory = async () => {
  const response = await fetch(
    "http://localhost:8088/colonyInventory?_expand=mineral"
  );
  return await response.json();
};
...
export const editColonyInventory = async (id, obj) => {
  ...
  const response = await fetch(
    `http://localhost:8088/colonyInventory/${id}`,
    patchOptions
  );
  return response.json();
};
...
export const getPirateInventory = async () => {
  const response = await fetch(
    `http://localhost:8088/pirateInventory?_expand=mineral`
  );
  return response.json();
};
...
export const editPirateInventory = async (id, obj) => {
  ...
  const response = await fetch(
    `http://localhost:8088/pirateInventory/${id}`,
    patchOptions
  );
  return response.json();
};
